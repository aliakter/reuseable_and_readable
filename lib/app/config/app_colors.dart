...
class AppColors {
  static const Color bgColor = Color(0xFF194185);
  static const Color bodyColor = Color(0xFFF5FAFF);
  static const Color buttonColor = Color(0xFFD17C3D);
  static const Color whiteColor = Color(0xFFFFFFFF);
  static const Color blackColor = Color(0xFF101828);
  static const Color redColor = Color(0xFFFF0C0C);
  static const Color red12Color = Color(0xFFFF422C);
  static const Color red13Color = Color(0xFFFF9003);
